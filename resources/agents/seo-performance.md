...
**LCP subparts** (TTFB, resource load delay, resource load time, element render delay) are now available in CrUX data (February 2025). See `resources/references/cwv-thresholds.md` for details.
